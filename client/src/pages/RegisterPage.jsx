  ...
  return (
    <div className="min-h-[85vh] flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-[#F7F0E3] text-[#3A2418]">
      ...
      <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-lg">
        <TiltedCard
          altText="CrowdTrust Registration"
          captionText="Create your CrowdTrust account"
          ...
          overlayContent={
            <SpotlightCard
              className="p-8 space-y-6 shadow-warm-lg rounded-3xl border border-[#DCCBB5] bg-[#FBF7EF] registration-spotlight-card w-full"
